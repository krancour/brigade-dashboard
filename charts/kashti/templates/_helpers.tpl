...
Common labels
*/}}
{{- define "kashti.labels" -}}
helm.sh/chart: {{ include "kashti.chart" . }}
{{ include "kashti.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kashti.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kashti.name" . }}
